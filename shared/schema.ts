...
export const products = pgTable("products", {
  ...
  bestSelling: boolean("best_selling").default(false),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export type CartWithProduct = Cart & { product: ProductWithCategory };
export type WishlistWithProduct = Wishlist & { product: ProductWithCategory };
